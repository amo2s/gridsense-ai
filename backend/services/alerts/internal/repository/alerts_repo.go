...
type AlertRepository interface {
    ...
    GetByID(ctx context.Context, id any) (db.Alert, error)
...
func (r *pgAlertRepository) GetByID(ctx context.Context, id any) (db.Alert, error) {
    ...
    alert, err := r.queries.GetAlertByID(ctx, id) // Pass the exact type required by sqlc
    if err != nil {
